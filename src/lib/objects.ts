export interface ObjectDef {
  id: string;
  label: string;
  category: "people" | "vehicles" | "animals" | "objects" | "delivery";
  plusOnly: boolean;
}
...
const PLUS_OBJECTS: ObjectDef[] = [
  { id: "face", label: "Face", category: "people", plusOnly: true },
  { id: "license_plate", label: "License Plate", category: "vehicles", plusOnly: true },
  ...
  { id: "kangaroo", label: "Kangaroo", category: "animals", plusOnly: true },
  ...
  { id: "amazon", label: "Amazon", category: "delivery", plusOnly: true },
  { id: "ups", label: "UPS", category: "delivery", plusOnly: true },
  { id: "fedex", label: "FedEx", category: "delivery", plusOnly: true },
  { id: "usps", label: "USPS", category: "delivery", plusOnly: true },
  { id: "dhl", label: "DHL", category: "delivery", plusOnly: true },
];
...
export const AUDIO_LABELS: AudioLabelDef[] = [
  ...
  { id: "smoke_detector", label: "Smoke Detector", category: "alarm" },
  ...
  { id: "doorbell", label: "Doorbell", category: "environment" },
